...
export function Sidebar({
  ...
  return (
    <TooltipProvider>
      <aside className="w-96 h-full bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-6 overflow-hidden transition-all duration-300 ease-in-out flex flex-col">
        {onClose && (
        ...
        {items.length > 0 && (
          <div className="space-y-4 mb-6">
            ...
            <Card className={`${totalSelectedSize > 0
              ...
              <CardHeader className="pb-2">
                <CardTitle className={`text-sm font-semibold flex items-center space-x-2 ${totalSelectedSize > 0
                  ? 'text-green-800 dark:text-green-200'
                  : 'text-gray-600 dark:text-gray-400'
                  }`}>
                  <div className={`w-6 h-6 rounded-lg flex items-center justify-center ${totalSelectedSize > 0
              ...
              <CardContent>
                <div className={`text-xl font-bold ${totalSelectedSize > 0
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 flex-1 flex flex-col min-h-0">
          ...
          <div className="space-y-3 flex-1 overflow-y-auto min-h-0">
            {CATEGORY_ORDER.map(cat => {
              ...
              if (!list || list.length === 0) return (
                <div key={cat} className="flex items-start space-x-3 py-3 opacity-30 cursor-not-allowed">
              ...
              return (
                <div
                  key={cat}
                  className={`rounded-xl p-4 transition-colors cursor-pointer ${isActive
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-start space-x-3 min-w-0 flex-1">
                      <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5 ${isActive
                          ? 'bg-blue-600 dark:bg-blue-500'
                          : 'bg-blue-100 dark:bg-blue-900'
                        }`}>
                        <FolderOpen className={`w-4 h-4 ${isActive
                            ? 'text-white'
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start space-x-2">
                          <div className={`font-semibold text-sm leading-5 ${isActive
                  ...
                  {selCount > 0 && (
                    <div className={`flex items-center justify-between pt-2 mt-2 border-t -mx-4 px-4 py-2 rounded-b-xl ${isActive
                      ...
                      <div className="flex items-center space-x-2">
                        <div className={`w-3 h-3 rounded-full animate-pulse ${isActive ? 'bg-blue-600' : 'bg-green-500'
                          }`}></div>
