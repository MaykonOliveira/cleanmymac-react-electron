          ...
          {CATEGORY_ORDER.map(cat => {
            ...
            return (
              <div key={cat} className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                ...
                {selCount > 0 && (
                  <div className="flex items-center justify-between pt-2 mt-2 border-t border-gray-200 dark:border-gray-600 bg-green-50 dark:bg-green-900/20 -mx-4 px-4 py-2 rounded-b-xl">
